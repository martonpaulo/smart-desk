...
export function EisenhowerQuadrant({
  ...
  let Icon: SvgIconComponent = AlertIcon;
          ...
          {tasks.length === 0 ? (
            ...
            tasks.map(task => (
              <TaskCard
                ...
                onSelectChangeAction={onTaskSelectChange}
                onTaskDragStartAction={(_id, e) => onTaskDragStart(task, e)}
                onTaskDragOverAction={(_id, e) => onTaskDragOver(e)}
                onTaskDragEndAction={onTaskDragEnd}
              />
            ))
          )}
        </Stack>
